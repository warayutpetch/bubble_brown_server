var laundryController = require('../controllers/LaundryController');

module.exports = function (app) {

    app.post('/laundry/getLaundryBy', function (req, res) {
        console.log('/laundry/getLaundryBy', req.body)
        laundryController.getLaundryBy(req.body, function (err, task) {
